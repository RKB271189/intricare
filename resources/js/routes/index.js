...
import UserCreate from '../components/User/CreateComponent.vue';
import UserEdit from '../components/User/UpdateComponent.vue';
...
const routes = [
    ...
    { path: '/user/summary', component: UserIndex, name: 'user.list' },
